...
for i in second_grid:
    all_second[(i[0], i[1])] = 1
common = []
for i in first_grid:
    if all_second[i[0], i[1]] == 1:
        common.append(i)
mn = 1e2345
for i in common:
    if manhattan(i[0], 0, i[1], 0) < mn and manhattan(i[0], 0, i[1], 0) != 0:
        mn = manhattan(i[0], 0, i[1], 0)
print(mn)